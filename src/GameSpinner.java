...
public class GameSpinner extends JPanel {
    ...
    public void hasBorders(boolean borders) {
        /*
         * Borders on/off
         * If switched on, borders of sections and circle _ circle center will be visible
         */
        hasBorders = borders;
        _image = null;
        _spinOnOff = false;
    ...
    public double getRotationAngle() {
        /*
         * Get current rotation of the spinner
         */
    ...
    public int getRadius() {
         ...
         * The radius is set in DrawImage method base on the dimensions of this
         */
        return _radius;
    }
    ...
    public void setSpinDeceleration(double deceleration) throws Exception {
        if (deceleration > 0) {
            throw new Exception("Illegal paramenter value: deceleration must be < 0");
        }
    ...
    public void paintComponent(Graphics g) {
        /*
         * Paintcomponent - if the image is null, create it and then draw ti whilst keeping the current rotation
    ...
    public void spinStartAsync(double speed, int direction, double deceleration) throws Exception {
         ...
         */
        if (deceleration > 0) {
            throw new Exception("Illegal parameter value: deceleration must be < 0");
        }
    ...
    private class SpeedTimerTask extends TimerTask {
        /*
         * TimerTask class that monitors and refreshes the spinSpeed
